...
func main() {
	...
	cs.History = []*genai.Content{
	  &genai.Content{
	    Parts: []genai.Part{
	      genai.Text("For every sentence I type, tell me if the sentence is correct German."),
	      genai.Text("Speak to me as if I were learning German and at the B2 level."),
	    },
	    Role: "user",
	  },
	  &genai.Content{
	...
	for {
		...
		prompt = "Is this sentence correct:" + prompt
